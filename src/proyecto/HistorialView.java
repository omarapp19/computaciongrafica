...
private TableRowSorter<DefaultTableModel> sorterCertificados;
    ...
    // --- ¡¡¡NUEVO BLOQUE #2!!! (Para Certificados) ---
    ...
    txtBuscarCertificado.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        // 2. Llenar ambas tablas al abrir
        cargarTablaExamenes();
        cargarTablaCertificados();
    }
...
/**
 * ¡¡¡NUEVO!!!
 * Filtra la tabla de certificados.
 */
private void filtrarTablaCertificados() {
    ...
    private void cargarTablaExamenes() {
        ...
        // Consulta SQL que une exámenes con estudiantes para mostrar el nombre
    ...
    /**
     * Carga TODOS los certificados de TODOS los estudiantes
     */
