...
public class AgregarCertificadoView extends javax.swing.JDialog {


    private String cedulaEstudiante;
    private boolean guardadoExitoso = false; 

    public AgregarCertificadoView(javax.swing.JInternalFrame parent, boolean modal, String cedulaEstudiante) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if (fecha.isEmpty() || nivel.isEmpty()) {
            JOptionPane.showMessageDialog(this, "La fecha y el nivel son obligatorios.", "Error", JOptionPane.WARNING_MESSAGE);
            return;
        }

     
        Connection conn = Conexion.getConexion();
        String sql = "INSERT INTO certificados (fecha_emision, nivel_certificado, codigo_unico, id_estudiante_fk) " +
                     "VALUES (?, ?, ?, ?)";
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            JOptionPane.showMessageDialog(this, "Error al guardar el certificado: " + e.getMessage(), "Error SQL", JOptionPane.ERROR_MESSAGE);
            this.guardadoExitoso = false;
        }
    }                                          
