...
public class RepresentantesView extends javax.swing.JInternalFrame {
    ...
    // --- Variable de Control ---
    private boolean modoEdicion = false; // true = Modificando, false = Creando Nuevo
    private TableRowSorter<DefaultTableModel> sorter;
    /**
     * Creates new form RepresentantesView
     */
    ...
    // --- ¡¡¡NUEVO BLOQUE #1!!! ---
    // 4. Inicializar y aplicar el Sorter
    ...
    // --- ¡¡¡NUEVO BLOQUE #2!!! ---
    // 5. Añadimos el "oyente" al campo de búsqueda
    txtBuscar.addKeyListener(new java.awt.event.KeyAdapter() {
        @Override
        public void keyReleased(java.awt.event.KeyEvent evt) {
            // Llama al nuevo método de filtrado
        ...
        // 3. Llenamos la tabla con datos reales de la BD
        cargarTablaRepresentantes();
    }
...
private void filtrarTablaRepresentantes() {
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        this.modoEdicion = false; // Resetea el flag
    }                                           
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if (this.modoEdicion) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                ...
                pstmt.setString(4, cedula); // El WHERE
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        // Cargar datos (OJO: verificar que no sean nulos)
        ...
        btnGuardar.setEnabled(true);
        btnCancelar.setEnabled(true);
        txtCedula.setEnabled(false); // No dejamos editar la cédula (PK)
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                ...
                if (filasAfectadas > 0) {
                 ...
                 // Esto es importante: si tiene estudiantes, SQLite dará un error de FOREIGN KEY
