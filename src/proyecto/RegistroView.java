...
public class RegistroView extends javax.swing.JDialog {
    ...
    public RegistroView(java.awt.Frame parent, boolean modal) {
        ...
        // 1. ¡NUEVO TAMAÑO! Más pequeño que el Login.
        setSize(550, 650); 
        
        // 2. Centrar sobre el Login
        setLocationRelativeTo(parent); 
        
        // 3. Configurar fondo y logo
        configurarFondo();
        configurarLogo();
        
        // 4. Panel semitransparente
        panelRegistro.setBackground(new Color(255, 255, 255, 220)); 
    }
    
    // --- MÉTODOS VISUALES (Copiados de LoginView) ---
    
    private void configurarFondo() {
        // Usa la misma imagen de fondo del login
        ...
        try {
            ...
            // Escala la imagen al nuevo tamaño (550x650)
